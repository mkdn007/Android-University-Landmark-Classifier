...
public class ClassifierActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  /** Image Title for 3sec delay */
  private String imageTitle;
  /** Start time for 3sec delay */
            ...
            if (classifier != null) {
              ...
              runOnUiThread(
                  new Runnable() {
                    @Override
                    public void run() {
                      Float best_match_prob = results.get(0).getConfidence();
                      temp.best_match_title = results.get(0).getTitle();

                      if (best_match_prob > 0.8 ){
                        Intent intent = new Intent(ClassifierActivity.this, LandmarkActivity.class);
                        startActivity(intent);
                        finish();
                      }
                     /* else if (best_match_prob > 0.7 && System.currentTimeMillis()-startTime>30000){
                        Intent intent = new Intent(ClassifierActivity.this, LandmarkActivity.class);
                        startActivity(intent);
                        finish();
                      }*/
